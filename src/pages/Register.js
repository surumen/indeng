...
class Register extends Component {
	...
	confirmSignUp = () => {
	    Auth.confirmSignUp(this.state.username)
		    ...
		    <div className="_2xL16d8I">
		      <div className="_34YvCqhu">
		        ...
		        <form onSubmit={this.confirmSignUp}>
		          <div className="jesRnsBI">
		            ...
		            <div className="_1e4pwiZP">
		              <div className="_1qXwAf4D">
		              	<input className="_1I4jFp30" type="email"  onChange={evt => this.onChange('email', evt.target.value)}/>
		              </div>
		            </div>
		          </div>
		          <div className="jesRnsBI">
		            ...
		            <div className="_1e4pwiZP _2-oBdneN">
		              ...
		              <div className="_1qXwAf4D">
		              	<input className="_1I4jFp30" onChange={evt => this.onChange('username', evt.target.value)} placeholder='username' />
		              </div>
		            </div>
		          </div>
		          <div className="jesRnsBI">
		            ...
		            <div className="_1e4pwiZP">
		              <div className="_1qXwAf4D">
		              	<input className="_3E42cSFo _1I4jFp30" placeholder="password" type="password" onChange={evt => this.onChange('password', evt.target.value)} />
		              </div>
		            </div>
		            <div className="_3GskkEns _3E42cSFo" />
		          </div>
		          <div className="jesRnsBI">
		            <div className="_2UjXVGgM"><label className="_2mqLfVWJ">Phone number</label></div>
		            <div className="_1e4pwiZP">
		              <div className="_1qXwAf4D">
		              	<input className="_3E42cSFo _1I4jFp30" name="phone_number" onChange={evt => this.onChange('phone_number', evt.target.value)} />
		              </div>
		            </div>
		          </div>
		          ...
		          <div className="jesRnsBI">
			          <button className="_1FV7R-ay _1ToZS6IW _2jkiZdBH _1Jylq1O2" onClick={this.confirmSignUp} data-element="button" type="submit">
			          	<span className="JcC8FCE5"><span>Confirm Sign Up</span></span>
			          </button>
		          </div>
		        </form>
		      </div>
