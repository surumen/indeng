...
class ImprovedGrades extends Component {
  render() {
    return (
    <div id="root">
	      ...
	      <div className="_2OB0ulxm">
	        ...
	        <div>
	          <div className="_2sAv_pF9">
	            <img src="https://mssg.me/upload/images/eewk73aju2lx69h.png" alt="Final Grades" />
	            <div className="_3bNWR2gD">
	          		<a href="/features/weekly_assignments" />
	          		<a href="/features/extracurricular" className="_2N4XpsHB" />
	          	</div>
	          </div>
	        </div>
	        <div className="_3i4bFa2x">
	          <div className="_1wR-CUow">
	            <h1>Improved Final Grades
	            </h1>
	          </div>
